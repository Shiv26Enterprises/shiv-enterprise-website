  ...
  return (
    <SiteShell>
      <PageIntro
        ...
        text="Ironclad is a practical equipment exchange for industrial buyers who value straight facts, visible availability and responsive conversations."
      />
      <section className="mx-auto max-w-[1200px] px-4 py-20 sm:px-6">
        <div className="grid gap-10 lg:grid-cols-[.8fr_1.2fr]">
          ...
          <div className="space-y-5 leading-7 text-muted-foreground">
            <p>
              Ironclad Machinery Co. is a configurable demonstration business identity. Replace the
              company details, proof points and contact information from the local admin before
              public use.
            </p>
            <p>
