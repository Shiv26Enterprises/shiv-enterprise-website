    ...
    <SiteShell>
      <section className="mx-auto max-w-[1480px] px-4 py-10 sm:px-6 lg:px-10">
        ...
        <div className="mt-8 grid gap-10 lg:grid-cols-[1.15fr_.85fr]">
          <div>
            <div className="relative aspect-[4/3] overflow-hidden rounded-[1.5rem] bg-graphite sm:rounded-[2rem]">
          ...
          <div>
            ...
            <h1 className="mt-3 text-4xl uppercase leading-none sm:text-6xl">{machine.name}</h1>
          ...
          <section>
            ...
            <dl className="mt-7 border-t border-border">
              {machine.specs.map((s) => (
                <div
                  key={s.label}
                  className="grid gap-1 border-b border-border py-4 sm:grid-cols-[.8fr_1.2fr] sm:gap-4"
                >
